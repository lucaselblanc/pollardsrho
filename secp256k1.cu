...
__constant__ uint64_t P_CONST[8] = {
    0x00000000FFFFFC2FULL, 0x00000000FFFFFFFEULL,
    0x00000000FFFFFFFFULL, 0x00000000FFFFFFFFULL,
    0x00000000FFFFFFFFULL, 0x00000000FFFFFFFFULL,
    0x00000000FFFFFFFFULL, 0x00000000FFFFFFFFULL
};

__constant__ uint64_t N_CONST[8] = {
    0x00000000D0364141ULL, 0x00000000BFD25E8CULL,
    0x00000000AF48A03BULL, 0x00000000BAAEDCE6ULL,
    0x00000000FFFFFFFEULL, 0x00000000FFFFFFFFULL,
    0x00000000FFFFFFFFULL, 0x00000000FFFFFFFFULL
};

__constant__ uint64_t GX_CONST[8] = {
    0x0000000016F81798ULL, 0x0000000059F2815BULL,
    0x000000002DCE28D9ULL, 0x00000000029BFCDBULL,
    0x00000000CE870B07ULL, 0x0000000055A06295ULL,
    0x00000000F9DCBBACULL, 0x0000000079BE667EULL
};

__constant__ uint64_t GY_CONST[8] = {
    0x00000000FB10D4B8ULL, 0x000000009C47D08FULL,
    0x00000000A6855419ULL, 0x00000000FD17B448ULL,
    0x000000000E1108A8ULL, 0x000000005DA4FBFCULL,
    0x0000000026A3C465ULL, 0x00000000483ADA77ULL
};

__constant__ uint64_t R_MOD_P[8] = {
    0x00000000000003D1ULL, 0x0000000000000001ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL
};

__constant__ uint64_t R2_MOD_P[8] = {
    0x000000000000E90A1ULL, 0x00000000000007A2ULL,
    0x0000000000000001ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL
};

__constant__ uint64_t R2_MOD_N[8] = {
    0x0000000067D7D140ULL, 0x00000000896CF214ULL,
    0x000000000E7CF878ULL, 0x00000000741496C2ULL,
    0x000000005BCD07C6ULL, 0x00000000E697F5E4ULL,
    0x0000000081C69BC5ULL, 0x000000009D671CD5ULL
};

__constant__ uint64_t MU_P = 0x00000000D2253531ULL;
__constant__ uint64_t MU_N = 0x000000005588B13FULL;

__constant__ uint64_t ZERO[8]  = {0ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL};
__constant__ uint64_t ONE[8]   = {1ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL};
__constant__ uint64_t TWO[8]   = {2ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL};
__constant__ uint64_t THREE[8] = {3ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL};
__constant__ uint64_t SEVEN[8] = {7ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL, 0ULL};

__constant__ uint64_t ONE_MONT[8] = {
    0x00000000000003D1ULL, 0x0000000000000001ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL
...
__constant__ uint64_t SEVEN_MONT[8] = {
    0x0000000000001A97ULL, 0x0000000000000007ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL
};
