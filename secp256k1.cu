...
__constant__ unsigned int R_MOD_P[8] = {
    ...
    0x00000000, 0x00000000, 0x00000001, 0x000003D1
};

__constant__ unsigned int R2_MOD_P[8] = {
    0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000001, 0x000007A2, 0x000E90A1, 0x00000000
};

__constant__ unsigned int R2_MOD_N[8] = {
    0x9D671CD5, 0x81C69BC5, 0xE697F5E4, 0x5BCD07C6,
    0x741496C2, 0x0E7CF878, 0x896CF214, 0x67D7D140
};
...
__constant__ unsigned int SEVEN_MONT[8] = {
    0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000007, 0x00001A97
};
