...
__device__ void mod_inverse_p(unsigned int *result, const unsigned int *a_normal) {
    ...
    for (int i = 0; i < 512; i++) {
        ...
        for (int j = 0; j < 4; j++) {
...

            {
                ...
                m = (unsigned int)(- (int)v_odd);
                t = (unsigned long long)v[0] + (u[0] & m);
                v[0] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)v[1] + (u[1] & m) + c;
                v[1] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)v[2] + (u[2] & m) + c;
                v[2] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)v[3] + (u[3] & m) + c;
                v[3] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)v[4] + (u[4] & m) + c;
                v[4] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)v[5] + (u[5] & m) + c;
                v[5] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)v[6] + (u[6] & m) + c;
                v[6] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)v[7] + (u[7] & m) + c;
                v[7] = (unsigned int)t; /*carry out descartado (mod 2^256)*/
            }

            {
                ...
                m = (unsigned int)(- (int)v_odd);
                t = (unsigned long long)r[0] + (q[0] & m);
                r[0] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[1] + (q[1] & m) + c;
                r[1] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[2] + (q[2] & m) + c;
                r[2] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[3] + (q[3] & m) + c;
                r[3] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[4] + (q[4] & m) + c;
                r[4] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[5] + (q[5] & m) + c;
                r[5] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[6] + (q[6] & m) + c;
                r[6] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[7] + (q[7] & m) + c;
                r[7] = (unsigned int)t;
            }
            ...
            unsigned int r_odd = r[0] & 1u;
            {
                ...
                m = (unsigned int)(- (int)r_odd);
                t = (unsigned long long)r[0] + (p[0] & m);
                r[0] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[1] + (p[1] & m) + c;
                r[1] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[2] + (p[2] & m) + c;
                r[2] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[3] + (p[3] & m) + c;
                r[3] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[4] + (p[4] & m) + c;
                r[4] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[5] + (p[5] & m) + c;
                r[5] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[6] + (p[6] & m) + c;
                r[6] = (unsigned int)t; c = (unsigned int)(t >> 32);

                t = (unsigned long long)r[7] + (p[7] & m) + c;
                r[7] = (unsigned int)t;
            }
...

    {
        ...
        if (cmp >= 0) {
            unsigned long long t;
            unsigned int b = 0;
            t = (unsigned long long)q[0] - p[0] - b; q[0] = (unsigned int)t; b = (t >> 63);
            t = (unsigned long long)q[1] - p[1] - b; q[1] = (unsigned int)t; b = (t >> 63);
            t = (unsigned long long)q[2] - p[2] - b; q[2] = (unsigned int)t; b = (t >> 63);
            t = (unsigned long long)q[3] - p[3] - b; q[3] = (unsigned int)t; b = (t >> 63);
            t = (unsigned long long)q[4] - p[4] - b; q[4] = (unsigned int)t; b = (t >> 63);
            t = (unsigned long long)q[5] - p[5] - b; q[5] = (unsigned int)t; b = (t >> 63);
            t = (unsigned long long)q[6] - p[6] - b; q[6] = (unsigned int)t; b = (t >> 63);
            t = (unsigned long long)q[7] - p[7] - b; q[7] = (unsigned int)t;
        }
    }
